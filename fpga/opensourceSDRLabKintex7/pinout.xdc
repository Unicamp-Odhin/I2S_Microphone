...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { i2s_ws }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN H11   IOSTANDARD LVCMOS33 } [get_ports { i2s_sd }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
